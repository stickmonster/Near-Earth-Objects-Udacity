...
class NEODatabase:
    ...
    def query(self, filters=()):
        ...
        """
        #I've used a lambda to succintly tie together (inline) the approach object 
        #and the filters, checking that they can be mapped together in order for
        #the generator in the query method to continue.
        for approach in self._approaches:
